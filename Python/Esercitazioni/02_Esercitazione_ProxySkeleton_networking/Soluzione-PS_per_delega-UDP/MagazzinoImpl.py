...
# Questo file contiene l'implementazione concreta di IMagazzino, gestendo 
# l'operazione di deposito e prelievo in due code 
# separate per laptop e smartphone
...
class MagazzinoImpl(IMagazzino):
    ...
    # Il metodo deposita Sincronizza l'accesso alla coda corrispondente, 
    # verifica se c'è spazio, aggiunge l'articolo e notifica i consumatori.
    ...
    # Il metodo preleva sincronizza l'accesso alla coda corrispondente, 
    # verifica se ci sono articoli, rimuove l'articolo e lo scrive su file, 
    # quindi notifica i produttori.
