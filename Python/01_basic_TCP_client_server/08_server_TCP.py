...
# getsockname -> per ricavare l'address di quella socket, 
# dalla quale possiamo recuperare il numero id porto
...
1 - py 08_server_TCP
    Restituirà un porto. Per es. 54689

2 - py 08_client_TCP 54689
