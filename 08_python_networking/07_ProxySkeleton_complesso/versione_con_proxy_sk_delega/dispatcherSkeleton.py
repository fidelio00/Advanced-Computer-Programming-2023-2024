...
class DispatcherSkeleton(DispatcherService): 
    # DispatcherSkeleton funge da intermediario tra il dispatcher 
    # e il mondo esterno tramite socket TCP. 
    # Gestisce le richieste dei client e le inoltra al dispatcher 
    # per l'elaborazione.
