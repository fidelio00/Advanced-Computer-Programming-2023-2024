...
if __name__ == "__main__":
    ...
    dispatcherImpl = dispatcherImpl() #istanziamo il dispatcher
    dispatcherSkeleton = DispatcherSkeleton(HOST, int(PORT), dispatcherImpl) #istanziamo il dispatcher skeleton
