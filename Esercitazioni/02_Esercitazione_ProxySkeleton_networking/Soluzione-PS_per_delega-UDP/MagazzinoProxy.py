...
# Questo file implementa il lato client,
# utilizzando una socket UDP per comunicare con il server.
...
class MagazzinoProxy (IMagazzino):
    ...
    # Crea un messaggio di deposito, lo invia al server, e ritorna il risultato.
    ...
    #  Crea un messaggio di prelievo, lo invia al server, e ritorna il risultato.
